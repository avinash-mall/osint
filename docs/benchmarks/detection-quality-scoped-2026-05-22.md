...
| ~~GROUNDING_DINO~~ | ❌ Removed (was auto-gated) | +0.31 mAP | +208 ms | Open-vocab recall; was auto-gated when all prompts are in SAM3+DOTA common vocab. Layer since removed. |
