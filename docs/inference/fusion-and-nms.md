...
- **Overlay labels additive** — Prithvi flood/burn polygons add `"water"` / `"burn_scar"` labels when their mask × Prithvi overlay IoU exceeds `SAM3_PRITHVI_OVERLAY_THRESHOLD`.
