...
## Purpose
Compute a DINOv3-SAT 1024-d embedding of a single image. Lightweight alternative to `POST /detect` for callers that only need the embedding, not the full SAM3/DOTA pipeline.
