...
- **Open-vocabulary segmentation** — SAM3's native API accepts free-text prompts, produces pixel masks. Closed-vocab specialists (DOTA-OBB, YOLOE-pf) emit boxes from a fixed list; SAM3 fills the gap for anything not in those lists.
